...
window.onload = function newGame(){
	var paramenters = {};
	$.ajax({
        url: 'http://albertocantug.com/connect4api/public/newUser',
        type: 'POST',
        method: 'POST',
        data : JSON.stringify(paramenters),
        async : true,
...
function checkGame(){
	var paramenters = {};
	$.ajax({
        url: 'http://albertocantug.com/connect4api/public/checkGame/'+token,
        method: 'GET',
        data : JSON.stringify(paramenters),
        success: function(json){
...
function movimiento(){
	...
	$.ajax({
		url: 'http://albertocantug.com/connect4api/public/move',
		method: 'POST',
		data: JSON.stringify({token:token, move:columna}),
		success: function(json){
